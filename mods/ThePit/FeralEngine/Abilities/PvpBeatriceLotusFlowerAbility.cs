...
namespace ThePit.FeralEngine.Abilities {
    internal class PvpBeatriceLotusFlowerAbility {
        internal static readonly FieldInfo CasterField = AccessTools.Field(typeof(BeatriceLotusFlowerAbility), "_projectileCaster");
        ...
        internal PvpBeatriceLotusFlowerAbility(BeatriceLotusFlowerAbility inst) { _inst = inst; }
