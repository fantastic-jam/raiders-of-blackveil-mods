...
namespace ThePit.Patch.Abilities {
    internal class PvpBeatriceAttackAbility {
        internal static readonly FieldInfo CasterField = AccessTools.Field(typeof(BeatriceAttackAbility), "_projectileCaster");
        ...
        internal PvpBeatriceAttackAbility(BeatriceAttackAbility inst) { _inst = inst; }
