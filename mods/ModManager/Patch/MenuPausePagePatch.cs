    ...
    internal static class MenuPausePagePatch {
        ...
        internal static void Apply(Harmony harmony) {
            ...
            if (_cursorField == null) {
                ModManagerMod.PublicLogger.LogWarning("ModManager: MenuPausePage._cursor not found — Mods button keyboard nav unavailable.");
            }

            var onInit = AccessTools.Method(typeof(MenuPausePage), "OnInit");
            if (onInit == null) {
                ModManagerMod.PublicLogger.LogWarning("ModManager: MenuPausePage.OnInit not found — in-game Mods button skipped.");
                return;
            }
        ...
        private static void OnInitPostfix(MenuPausePage __instance) {
            ...
            if (optionsBtn == null) {
                ModManagerMod.PublicLogger.LogWarning("ModManager: OptionsButton not found in pause menu — Mods button skipped.");
                return;
            }
